      ...
      <div class="modal-body">
        <form action="" method="post">
                    ...
                    <select class="form-control" name="class" id="tipo">
                        ...
                        <option value="event-important">Apertura</option>
                        <!-- <option value="event-warning">Advertencia</option> !-->
                        <option value="event-special">Descuento</option>
                    </select>
                    ...
                    <textarea id="body" name="event" required class="form-control" rows="10"></textarea>
